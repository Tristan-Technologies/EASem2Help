...
#V4: Added integration with camera gimbal servo
import machine
...
PWMServoAz = PWM(Pin(18), freq = 50)
PWMServoEl = PWM(Pin(19), freq = 50)

refresh_rate = 20 #(miliseconds)
...
while True:
    ...
    if gasCounter >= 3000/refresh_rate:
