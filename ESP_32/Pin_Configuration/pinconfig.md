...
For the toggle switch, it's connected to 3.3v and pin4. Once it's toggled , pin4 will read a digital high signal and the control mode will switch to servo.(Right part of the picture)
