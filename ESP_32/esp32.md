...
For the purposes of the project, an Espressif ESP32-WROOM-32D controller board will be used. Upon arriving, the board is initially configured and flashed to operate with the Arduino Process language, and consequently had to be re-flashed to operate using micropython. The setup guide, found [here](http://docs.micropython.org/en/latest/esp32/tutorial/intro.html#esp32-intro), is a relatively straightforward document to follow along, although it was written with the assumption that the user is running a UNIX system. This part on configuring the board was done using a Windows system, hence, a modified version of the guide will be written here that features modifications to the commands to better suit a Windows system.
...
![COM Port](../ESP_32/Pictures/COM_port.PNG)
...
![Download Firmware](../ESP_32/Pictures/Firmware.PNG)
...
![Firmware Erase](../ESP_32/Pictures/erase.PNG)
...
![Firmware Erase](../ESP_32/Pictures/flash.PNG)
...
![Flashing Sucessful](../ESP_32/Pictures/sucessful.PNG)
